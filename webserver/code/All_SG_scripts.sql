...
values ('Banginapalli','Mangoes','Approx 4.5kg/10 pcs','32','29','N');

insert into products (name,category,units,price,offerprice,instock)
values ('Alphonso','Mangoes','Approx 2.8kg/12 pcs','32','30','N');

insert into products (name,category,units,price,offerprice,instock)
values ('Kesar','Mangoes','Approx 4.2kg/10 pcs','32','29','N');

insert into products (name,category,units,price,offerprice,instock)
values ('Mixed','Mangoes','Approx 4.2kg/12+ pcs','31','29','N');

insert into products (name,category,units,price,offerprice,instock)
values ('Neelam','Mangoes','Approx 4.2kg/12+ pcs','35','32','N');

insert into  products (name,category,units,price,offerprice,instock)
values ('ImamPasand','Mangoes','Approx 4.5kg/6+ pcs','42','40','N');
...
insert into react_config (name,JSON_STRING)
values('DEL_DATE','{"value":"Starting 24rd April(Wednesday)"}');
